...
<form action="updatepen" method="POST">
	<input type="text" name="id" id="id" value="${pen.id }" hidden>
	<div class="mb-3">
    	<label for="pid" class="form-label">Product ID</label>
    	<input type="text" class="form-control" id="pId" name="pId" value="${pen.pId}" readonly>
  </div>
  <div class="mb-3">
    	<label for="pname" class="form-label">Product Name</label>
    	<input type="text" class="form-control" id="pName" name="pName" value="${pen.pName }">
  </div>
  <div class="mb-3">
