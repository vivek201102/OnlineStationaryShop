                        ...
                        <div class="col-12">
                            ...
                            <form action="updatepen" method="POST">
                                <div class="card-body">
								 ...
								 <form action="updatepen" method="POST">
								 <input type="text" name="id" value="${pen.getId() }" hidden>
                                    <div class="form-group row">
                                        <label for="example-email-input" class="col-sm-2 col-form-label">ID</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="pId" value="${pen.getpId() }">
                                        </div>
										<label for="example-url-input" class="col-form-label">Name</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="pName" value="${pen.getpName() }">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="des" value="${pen.getDes() }">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="compName" value="${pen.getCompName() }">
                                        </div>
										<label for="example-url-input" class="col-form-label">Color</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="color" value="${pen.getColor() }">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" type="number" name="price" value="${pen.getPrice() }">
                                        </div>
										<label for="example-url-input" class="col-form-label">Quantity</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="number" name="stock" value="${pen.getStock() }">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="image" value="${pen.getImage() }">
                                        </div>
                                    </div>
