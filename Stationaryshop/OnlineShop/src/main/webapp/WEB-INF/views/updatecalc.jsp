                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
								 ...
								 <input type="text" name="id" value="${calc.getId() }" hidden>
                                    <div class="form-group row">
                                        <label for="example-email-input" class="col-sm-2 col-form-label">ID</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="pId" value="${calc.getpId() }" readonly>
                                        </div>
										<label for="example-url-input" class="col-form-label">Name</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="pName" value="${calc.getpName() }">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="des" value="${calc.getDes() }">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="compName" value="${calc.getCompName() }">
                                        </div>
										<label for="example-url-input" class="col-form-label">Type</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="type" value="${calc.getType() }">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" type="number" name="price" value="${calc.getPrice() }">
                                        </div>
										<label for="example-url-input" class="col-form-label">Quantity</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="number" name="stock" value="${calc.getStock() }">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="image" value="${calc.getImage() }">
                                        </div>
                                    </div>
