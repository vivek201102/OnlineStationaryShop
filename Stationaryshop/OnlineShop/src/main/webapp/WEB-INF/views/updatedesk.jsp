                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
								 ...
								 <input type="text" name="id" value="${desk.getId() }" hidden>
                                    <div class="form-group row">
                                        <label for="example-email-input" class="col-sm-2 col-form-label">ID</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="pId" value="${desk.getpId() }" readonly>
                                        </div>
										<label for="example-url-input" class="col-form-label">Name</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="pName" value="${desk.getpName() }">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="des" value="${desk.getDes() }">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="compName" value="${desk.getCompName() }">
                                        </div>
										<label for="example-url-input" class="col-form-label">Material</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" name="material" value="${desk.getMaterial() }">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" type="number" name="price" value="${desk.getPrice() }">
                                        </div>
										<label for="example-url-input" class="col-form-label">Quantity</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" type="number" name="stock" value="${desk.getStock() }">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="image" value="${desk.getImage() }">
                                        </div>
                                    </div>
